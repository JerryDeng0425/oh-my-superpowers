...
START_SCRIPT="$REPO_ROOT/skills/omo-brainstorming/scripts/start-server.sh"
STOP_SCRIPT="$REPO_ROOT/skills/omo-brainstorming/scripts/stop-server.sh"
SERVER_JS="$REPO_ROOT/skills/omo-brainstorming/scripts/server.js"
