...
| File | Change |
|---|---|
| `skills/omo-using-git-worktrees/SKILL.md` | +12 lines (Step 0) |
| `skills/omo-finishing-a-development-branch/SKILL.md` | +20 lines (Step 1.5 + cleanup guard) |
| `skills/omo-subagent-driven-development/SKILL.md` | 1 line edit |
| `skills/omo-executing-plans/SKILL.md` | 1 line edit |
| `skills/omo-using-superpowers/references/codex-tools.md` | +15 lines |
