...
**Location:** `skills/omo-brainstorming/spec-document-reviewer-prompt.md`
...
**Location:** `skills/omo-writing-plans/plan-document-reviewer-prompt.md`
...
**New files:**
- `skills/omo-brainstorming/spec-document-reviewer-prompt.md`
- `skills/omo-writing-plans/plan-document-reviewer-prompt.md`

**Modified files:**
- `skills/omo-brainstorming/SKILL.md` - add review loop after spec written
- `skills/omo-writing-plans/SKILL.md` - add chunk-by-chunk review loop, update task syntax examples
