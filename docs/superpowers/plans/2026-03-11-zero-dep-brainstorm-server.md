...
> **For agentic workers:** REQUIRED: Use omo-subagent-driven-development (if subagents available) or omo-executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **Create:** `skills/omo-brainstorming/scripts/server.js` — the zero-dep replacement
- **Modify:** `skills/omo-brainstorming/scripts/start-server.sh:94,100` — change `index.js` to `server.js`
- **Modify:** `.gitignore:6` — remove the `!skills/omo-brainstorming/scripts/node_modules/` exception
- **Delete:** `skills/omo-brainstorming/scripts/index.js`
- **Delete:** `skills/omo-brainstorming/scripts/package.json`
- **Delete:** `skills/omo-brainstorming/scripts/package-lock.json`
- **Delete:** `skills/omo-brainstorming/scripts/node_modules/` (714 files)
- **No changes:** `skills/omo-brainstorming/scripts/helper.js`, `skills/omo-brainstorming/scripts/frame-template.html`, `skills/omo-brainstorming/scripts/stop-server.sh`
...
**Files:**
- Create: `skills/omo-brainstorming/scripts/server.js`
...
```bash
git add skills/omo-brainstorming/scripts/server.js
...
**Files:**
- Modify: `skills/omo-brainstorming/scripts/server.js`
...
**Files:**
- Modify: `skills/omo-brainstorming/scripts/start-server.sh:94,100`
- Modify: `.gitignore:6`
- Delete: `skills/omo-brainstorming/scripts/index.js`
- Delete: `skills/omo-brainstorming/scripts/package.json`
- Delete: `skills/omo-brainstorming/scripts/package-lock.json`
- Delete: `skills/omo-brainstorming/scripts/node_modules/` (entire directory)
...
In `.gitignore`, delete line 6: `!skills/omo-brainstorming/scripts/node_modules/`

- [ ] **Step 3: Delete old files**

```bash
git rm skills/omo-brainstorming/scripts/index.js
git rm skills/omo-brainstorming/scripts/package.json
git rm skills/omo-brainstorming/scripts/package-lock.json
git rm -r skills/omo-brainstorming/scripts/node_modules/
```
...
```bash
git add skills/omo-brainstorming/scripts/ .gitignore
...
```bash
cd skills/omo-brainstorming/scripts
