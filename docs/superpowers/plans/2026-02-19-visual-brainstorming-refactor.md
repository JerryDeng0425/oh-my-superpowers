...
| `skills/omo-brainstorming/visual-companion.md` | Modify | Skill instructions: rewrite loop to non-blocking flow |
...
**Files:**
- Modify: `skills/omo-brainstorming/visual-companion.md`
...
```bash
git add skills/omo-brainstorming/visual-companion.md
