...
> **For agentic workers:** REQUIRED: Use omo-subagent-driven-development (if subagents available) or omo-executing-plans to implement this plan.
...
**Files:**
- Create: `skills/omo-brainstorming/spec-document-reviewer-prompt.md`
...
Run: `cat skills/omo-brainstorming/spec-document-reviewer-prompt.md | head -20`
Expected: Shows the header and purpose section

- [ ] **Step 3:** Commit

```bash
git add skills/omo-brainstorming/spec-document-reviewer-prompt.md
...
**Files:**
- Modify: `skills/omo-brainstorming/SKILL.md`

- [ ] **Step 1:** Read the current brainstorming skill

Run: `cat skills/omo-brainstorming/SKILL.md`
...
Run: `grep -A 15 "Spec Review Loop" skills/omo-brainstorming/SKILL.md`
Expected: Shows the new review loop section

- [ ] **Step 4:** Commit

```bash
git add skills/omo-brainstorming/SKILL.md
...
**Files:**
- Create: `skills/omo-writing-plans/plan-document-reviewer-prompt.md`
...
Run: `cat skills/omo-writing-plans/plan-document-reviewer-prompt.md | head -20`
Expected: Shows the header and purpose section

- [ ] **Step 3:** Commit

```bash
git add skills/omo-writing-plans/plan-document-reviewer-prompt.md
...
**Files:**
- Modify: `skills/omo-writing-plans/SKILL.md`

- [ ] **Step 1:** Read current skill file

Run: `cat skills/omo-writing-plans/SKILL.md`
...
Run: `grep -A 15 "Plan Review Loop" skills/omo-writing-plans/SKILL.md`
Expected: Shows the new review loop section

- [ ] **Step 5:** Verify the task syntax examples were updated

Run: `grep -A 5 "Task N:" skills/omo-writing-plans/SKILL.md`
Expected: Shows checkbox syntax `### Task N:`

- [ ] **Step 6:** Commit

```bash
git add skills/omo-writing-plans/SKILL.md
...
Run: `grep -A 20 "Plan Document Header" skills/omo-writing-plans/SKILL.md`
...
```markdown
> **For agentic workers:** REQUIRED: Use omo-subagent-driven-development (if subagents available) or omo-executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```

- [ ] **Step 3:** Verify the change

Run: `grep -A 5 "For agentic workers:" skills/omo-writing-plans/SKILL.md`
