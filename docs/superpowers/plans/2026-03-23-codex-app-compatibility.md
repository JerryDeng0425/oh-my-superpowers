...
> **For agentic workers:** REQUIRED SUB-SKILL: Use omo-subagent-driven-development (recommended) or omo-executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
|---|---|---|
| `skills/omo-using-git-worktrees/SKILL.md` | Worktree creation + isolation | Add Step 0 detection + sandbox fallback |
| `skills/omo-finishing-a-development-branch/SKILL.md` | Branch finishing workflow | Add Step 1.5 detection + cleanup guard |
| `skills/omo-subagent-driven-development/SKILL.md` | Plan execution with subagents | Update Integration description |
| `skills/omo-executing-plans/SKILL.md` | Plan execution inline | Update Integration description |
| `skills/omo-using-superpowers/references/codex-tools.md` | Codex platform reference | Add detection + finishing docs |
...
**Files:**
- Modify: `skills/omo-using-git-worktrees/SKILL.md:14-15` (insert after Overview, before Directory Selection Process)

- [ ] **Step 1: Read the current skill file**

Read `skills/omo-using-git-worktrees/SKILL.md` in full. Identify the exact insertion point: after the "Announce at start" line (line 14) and before "## Directory Selection Process" (line 16).
...
```bash
git add skills/omo-using-git-worktrees/SKILL.md
...
**Files:**
- Modify: `skills/omo-using-git-worktrees/SKILL.md:211-215` (Integration > Called by)
...
**Files:**
- Modify: `skills/omo-finishing-a-development-branch/SKILL.md:38` (insert after Step 1, before Step 2)

- [ ] **Step 1: Read the current skill file**

Read `skills/omo-finishing-a-development-branch/SKILL.md` in full. Identify the insertion point: after "**If tests pass:** Continue to Step 2." (line 38) and before "### Step 2: Determine Base Branch" (line 40).
...
```bash
git add skills/omo-finishing-a-development-branch/SKILL.md
...
**Files:**
- Modify: `skills/omo-finishing-a-development-branch/SKILL.md` (Step 5: Cleanup Worktree — find by section heading, line numbers will have shifted after Task 3)

- [ ] **Step 1: Read the current Step 5 section**

Find the "### Step 5: Cleanup Worktree" section in `skills/omo-finishing-a-development-branch/SKILL.md` (line numbers will have shifted after Task 3's insertion). The current Step 5 is:
...
**Files:**
- Modify: `skills/omo-subagent-driven-development/SKILL.md:268`
- Modify: `skills/omo-executing-plans/SKILL.md:68`
...
To:
```
- **omo-using-git-worktrees** - REQUIRED: Ensures isolated workspace (creates one or verifies existing)
```
...
Read line 268 of `skills/omo-subagent-driven-development/SKILL.md` and line 68 of `skills/omo-executing-plans/SKILL.md`. Confirm both say "Ensures isolated workspace (creates one or verifies existing)".

- [ ] **Step 4: Commit**

```bash
git add skills/omo-subagent-driven-development/SKILL.md skills/omo-executing-plans/SKILL.md
...
**Files:**
- Modify: `skills/omo-using-superpowers/references/codex-tools.md:25` (append at end)

- [ ] **Step 1: Read the current file**

Read `skills/omo-using-superpowers/references/codex-tools.md` in full. Confirm it ends at line 25-26 after the multi_agent section.
...
```bash
git add skills/omo-using-superpowers/references/codex-tools.md
...
- `skills/omo-using-git-worktrees/SKILL.md` — Step 0 present, rest unchanged
- `skills/omo-finishing-a-development-branch/SKILL.md` — Step 1.5 present, cleanup guard present, rest unchanged
- `skills/omo-subagent-driven-development/SKILL.md` — line 268 updated
- `skills/omo-executing-plans/SKILL.md` — line 68 updated
- `skills/omo-using-superpowers/references/codex-tools.md` — two new sections at end
