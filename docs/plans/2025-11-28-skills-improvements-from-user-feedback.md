...
1. Read testing-anti-patterns skill:
   Use Skill tool: omo-testing-anti-patterns
...
1. **verification-before-completion: Configuration change verification**
   ...
   - File: `skills/omo-verification-before-completion/SKILL.md`
...
3. **requesting-code-review: Explicit file reading**
   ...
   - File: `skills/omo-requesting-code-review/SKILL.md`
...
4. **subagent-driven-development: Process hygiene**
   ...
   - File: `skills/omo-subagent-driven-development/SKILL.md`
