...
- Create: `skills/omo-brainstorming/visual-companion.md` (supporting doc)

**Step 1: Create the supporting documentation**

Create `skills/omo-brainstorming/visual-companion.md`:
...
Add after "Key Principles" in `skills/omo-brainstorming/SKILL.md`:
...
Run: `grep -A5 "Visual Companion" skills/omo-brainstorming/SKILL.md`
Expected: Shows the new section

**Step 4: Commit**

```bash
git add skills/omo-brainstorming/
